...
public class CustomerInfoPUI {
	...
	public static final String IDENTIFICATION_ID_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtCustomerID']";
	public static final String IDENTIFICATION_DATE_ISSUE_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_calDateIssue_dateInput']";
	public static final String IDENTIFICATION_PLACE_ISSUE_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtPlaceIssue']";
	public static final String FULLNAME_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtFullName']";
	public static final String BIRTHDAY_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_calBirthDate_dateInput']";
	public static final String PHONENUMBER_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtPhoneNumber']";
	public static final String EMAIL_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtEmail']";
	public static final String PARTNER_USER_ID_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtPartnerUserID']";
	public static final String RACE_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtRace']";
	public static final String RELIGION_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtReligion']";
	public static final String HOME_PHONE_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtHomePhone']";
	public static final String COMPANY_PHONE_TEXTBOX = "//input[@id='dnn_ctr1482_CustomerDetail_txtCompanyPhone']";
	...
	//Saving
	public static final String SAVE_BUTTON = "//a[@id='dnn_ctr1482_CustomerDetail_btnInsert']";
	public static final String UPDATE_BUTTON = "//a[@id='dnn_ctr1482_CustomerDetail_btnUpdate']";
