...
public class UserInfoPUI {
	...
	public static final String ENABLE_BUTTON = "//a[@id='dnn_ctr392_UserDetail_btnEnable']";
	public static final String DISABLE_BUTTON = "//a[@id='dnn_ctr392_UserDetail_btnDisable']";
	public static final String ACCEPT_BUTTON = "//button[@class = 'btn btn-primary ui-button ui-corner-all ui-widget']";
	public static final String CANCEL_BUTTON = "//button[@class = 'btn btn-default ui-button ui-corner-all ui-widget dnnConfirmCancel']";
	public static final String MESSAGE_AFTER_SAVE = "//span[contains(text(),'Thêm mới thành công.')]";
	public static final String MESSAGE_AFTER_UPDATEORDISABLED = "//span[@id='dnn_ctr392_UserDetail_ctl01_lblMessage']";
